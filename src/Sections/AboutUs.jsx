...
const AboutUs = () => {
  return (
    <div
      className="bg-[#D9D9D9] flex justify-center items-center h-screen gap-20"
      id="about-us"
    >
      <img
      ...
      <div className=" flex flex-col gap-5 w-[338px] h-[395px] justify-center text-slate-700">
        ...
        <div className="flex flex-col text-lg text-justify gap-7">
          <p>
            Welcome to Pizzeria Bella Luna, where we serve up authentic Italian
            pizza made fresh daily.
          </p>
          <p>
            Our dough is handcrafted with love, and our toppings are always
            fresh and flavorful. Come join us for a slice of Italy in a warm and
            inviting atmosphere.
          </p>
