    ...
    <div className='h-screen w-full bg-[#D9D9D9] flex flex-col justify-around items-center text-slate-700' id='find-us'>
        <div className='flex gap-32 w-[720px]'>
            ...
            <div className="flex gap-10">
                <div>
                    <img src="https://firebasestorage.googleapis.com/v0/b/code-up-31d9f.appspot.com/o/pro-projects-ressources%2Frestaurant%2Flocate-fixed.png?alt=media" alt="" className='mt-1'/>
                </div>
