    ...
    <>
      <div className="h-screen w-full overflow-hidden flex flex-col items-center justify-center">
        <img
          ...
          className="w-full"
        />
        <div className="absolute bg-white opacity-70 w-[336px] h-[80px] sm:w-[452px] sm:h-[120px] flex items-center justify-center text-center rounded-lg">
          <p className="p-10 italic text-slate-700">
