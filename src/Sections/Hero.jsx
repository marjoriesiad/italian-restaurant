...
const Hero = () => {
  return (
    ...
    <div className='h-screen w-full overflow-hidden flex flex-col items-center justify-center'>
      <img src="https://firebasestorage.googleapis.com/v0/b/code-up-31d9f.appspot.com/o/pro-projects-ressources%2Frestaurant%2Fmain-picture.png?alt=media" alt="" className='w-full' />
